...
class TestTask:
    ...
    def test_is_recurring_property(self):
        ...
        daily = Task(title="T2", duration_minutes=10,
                     frequency=Frequency.DAILY)
        weekly = Task(title="T3", duration_minutes=10,
                      frequency=Frequency.WEEKLY)
        biweekly = Task(title="T4", duration_minutes=10,
...
class TestSchedulerSorting:
    ...
    def scheduler_with_tasks(self):
        ...
        pet.add_task(Task(title="Task4_unscheduled",
                     duration_minutes=15))  # No time
    ...
    def test_sort_by_priority_high_first(self):
        ...
        pet.add_task(
            Task(title="Low", duration_minutes=10, priority=Priority.LOW))
        pet.add_task(
...
class TestSchedulerFiltering:
    ...
    def scheduler_with_varied_tasks(self):
        ...
        dog.add_task(Task(title="Feed", duration_minutes=10, priority=Priority.HIGH,
                          ...
                          scheduled_time=datetime(2026, 3, 29, 8, 0)))
        dog.add_task(
            Task(title="Play", duration_minutes=20, priority=Priority.LOW))

        # Cat tasks
        cat.add_task(Task(title="Litter", duration_minutes=5,
                     priority=Priority.MEDIUM))
        task_complete = Task(title="Medication",
    ...
    def test_filter_by_pet(self, scheduler_with_varied_tasks):
        ...
        mochi_tasks = scheduler_with_varied_tasks.filter_by_pet(
            all_tasks, "Mochi")
    ...
    def test_filter_by_pet_unknown_returns_empty(self, scheduler_with_varied_tasks):
        ...
        unknown_tasks = scheduler_with_varied_tasks.filter_by_pet(
            all_tasks, "Unknown")
    ...
    def test_filter_by_status_pending(self, scheduler_with_varied_tasks):
        ...
        pending = scheduler_with_varied_tasks.filter_by_status(
    ...
    def test_filter_by_status_completed(self, scheduler_with_varied_tasks):
        ...
        completed = scheduler_with_varied_tasks.filter_by_status(
    ...
    def test_filter_by_priority(self, scheduler_with_varied_tasks):
        ...
        high_tasks = scheduler_with_varied_tasks.filter_by_priority(
            all_tasks, Priority.HIGH)
    ...
    def test_filter_by_time_range(self):
        ...
        pet.add_task(
            Task(title="T1", duration_minutes=10, scheduled_time=base))
    ...
    def test_filter_chain(self, scheduler_with_varied_tasks):
        ...
        result = scheduler_with_varied_tasks.filter_chain(
            all_tasks,
            lambda t: scheduler_with_varied_tasks.filter_by_status(
                t, completed=False),
            lambda t: scheduler_with_varied_tasks.filter_by_priority(
                t, Priority.HIGH)
        )
...
class TestConflictDetection:
    ...
    def test_detect_conflicts_finds_overlaps(self):
        ...
        # Task 1: 10:00 - 10:30
        task1 = Task(title="Task1", duration_minutes=30,
                     scheduled_time=base_time)
    ...
    def test_detect_conflicts_exact_same_time(self):
        ...
        task2 = Task(title="Task2", duration_minutes=20,
                     scheduled_time=same_time)
    ...
    def test_detect_conflicts_multiple_conflicts(self):
        ...
        pet.add_task(
            Task(title="T1", duration_minutes=30, scheduled_time=base))
    ...
    def test_get_conflict_free_tasks(self):
        ...
        safe, warnings = scheduler.get_conflict_free_tasks(
            owner.get_all_tasks())
...
class TestScheduleGeneration:
    ...
    def sample_owner(self):
        ...
        pet.add_task(Task(title="Play", duration_minutes=20,
                     priority=Priority.MEDIUM))
        pet.add_task(
            Task(title="Groom", duration_minutes=45, priority=Priority.LOW))
    ...
    def test_assign_times_sequential(self, sample_owner):
        ...
        assert tasks[1].scheduled_time == start + \
            timedelta(minutes=tasks[0].duration_minutes)
...
class TestSchedulerRecurring:
    ...
    def test_get_recurring_tasks(self):
        ...
        pet.add_task(Task(title="Once", duration_minutes=30,
                     frequency=Frequency.ONCE))
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        dog.add_task(Task(title="Morning walk",
        ...
        cat.add_task(Task(title="Litter box", duration_minutes=10,
                     priority=Priority.MEDIUM))
    ...
    def test_conflict_detection_and_resolution(self):
        ...
        pet.add_task(
            Task(title="Walk", duration_minutes=30, scheduled_time=base))
        pet.add_task(Task(title="Feed", duration_minutes=10,
                          # Conflict!
        ...
        safe_tasks, warnings = scheduler.get_conflict_free_tasks(
            owner.get_all_tasks())
...
class TestEdgeCases:
    ...
    def test_exact_time_budget_match(self):
        ...
        pet.add_task(
            Task(title="T1", duration_minutes=30, priority=Priority.HIGH))
        pet.add_task(
            Task(title="T2", duration_minutes=30, priority=Priority.HIGH))
    ...
    def test_task_at_midnight_boundary(self):
        ...
        task = Task(title="Midnight task", duration_minutes=30,
